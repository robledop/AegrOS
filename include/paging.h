...
#define PDE_WRITE_THROUGH 0b00001000
...
#define PDE_SUPERVISOR 0b00000100
...
#define PDE_IS_WRITABLE 0b00000010
...
#define PDE_IS_PRESENT 0b00000001

// Clear all flags to unmap the page
#define PDE_UNMAPPED 0x00
